...
import { listSessions, saveSession, deleteSession, type SavedSession } from "../lib/sessions";
import { writeShareStateToUrl } from "../lib/shareState";

interface SessionManagerProps {
  state: ShareableState;
  onLoadSession: (session: ShareableState) => void;
